...
export type IngredientTagsQuery = {
  __typename?: "Queries";
  allTags: Array<{
    __typename?: "TaggedIngredient";
    name: string;
...
export const IngredientTagsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ingredientTags" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<IngredientTagsQuery, IngredientTagsQueryVariables>;
